...
async def websocket_endpoint(websocket: WebSocket):
    ...
    for event in graph.stream({"messages": [input_message], "word": word}, config, stream_mode="values"):
        await websocket.send_text(event["messages"][-1].content)
